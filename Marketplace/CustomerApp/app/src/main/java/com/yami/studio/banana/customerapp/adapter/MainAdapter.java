package com.yami.studio.banana.customerapp.adapter;
...
import com.yami.studio.banana.customerapp.activity.detail.DetailActivity;
import com.yami.studio.banana.customerapp.entity.Product;

import java.text.DecimalFormat;
import java.util.List;

import static com.yami.studio.banana.customerapp.activity.detail.DetailActivity.EXTRA_DATA;
...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.MainHolder> {
    ...
    class MainHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(Product product){
            ...
            productPrice.setText(toMoney(product.getProductPrice()));
